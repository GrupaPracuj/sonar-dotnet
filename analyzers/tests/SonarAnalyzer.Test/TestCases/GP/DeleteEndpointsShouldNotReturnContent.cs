...
namespace Tests.Diagnostics
{
    ...
    public static class Endpoints
    {
        ...
        {
            app.MapDelete("/orders/1", () => Microsoft.AspNetCore.Http.Results.Ok(new object())); // Noncompliant
            app.MapDelete("/orders/2", () => Microsoft.AspNetCore.Http.TypedResults.Ok(new object())); // Noncompliant
        }
    }
}
